<div class="row ">
    <div class="form-grup col-12 mb-2 input-group-sm">
        ...
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <button class="btn btn-outline-secondary" type="submit" id="button-addon2">Set tgl</button>
            </div>
        </div>
        </form>
    </div>
       <?php $table = 'mutasi';?>
                    <?php $primary = 'idmutasi';?>
    <div class="col-12 col-lg-3 mb-2">
        <div class="card rounded shadow" style="zoom:85%">
            <h6 class="text-dark ml-2 mt-1 pt-1">Form Input Mutasi</h6>
            <div class=" card-body ">
                <form action="Action.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <?php foreach ($data['mutasi.form'] as $isi): ?>
                        ...
                        <?php elseif ($isi['name'] == 'idlokasi'): ?>
                        <div class="form-grup col-12 mb-2 input-group-sm">
                            <label class="form-control-label">Lokasi</label>
                            <select class="form-control " name="input[]">
                                <?php foreach ($data['lokasi'] as $a => $b): ?>
                                    <option value="<?php echo $b->idlokasi; ?>">
                                        <?php echo $b->nama_lokasi; ?>
                                    </option>
                                <?php endforeach;?>
                            </select>
                            <input type="hidden" name="tb[]" value="idlokasi">

                        </div>
                        <?php elseif ($isi['name'] == 'jenismutasi'): ?>
                        <div class="form-grup col-12 mb-2 input-group-sm">
                            <label class="form-control-label">Jenis Mutasi</label>
                            <select class="form-control " name="input[]">
                                    <option value="Keluar">Keluar</option>
                                    <option value="Masuk">Masuk</option>
                            </select>
                            <input type="hidden" name="tb[]" value="jenismutasi">
    ...
    <div class="col-12 col-lg-9 mb-2">
        <div class="card rounded shadow" style="zoom:85%">
            <h6 class="text-dark ml-2 mt-1 pt-1">Data Mutasi
                            <?php echo $data['tgl']; ?></h6>
